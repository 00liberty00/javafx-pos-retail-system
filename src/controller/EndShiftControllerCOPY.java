 ...
 * @author Dave
 */
public class EndShiftControllerCOPY implements Initializable {
    ...
    private static final Logger log = Logger.getLogger(EndShiftControllerCOPY.class);
...
//        kkt.cashOut(cash);
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EndShiftControllerCOPY.class.getName()).log(Level.SEVERE, null, ex);
        }
